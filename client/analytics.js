...
{
	if (region.aR.ae === region.a3.ae)
	{
		return 'on line ' + region.aR.ae;
	}
	return 'on lines ' + region.aR.ae + ' through ' + region.a3.ae;
}
...
var author$project$Analytics$LinkData = F2(
	function (longUrl, clicks) {
		return {a1: clicks, aJ: longUrl};
	});
...
var author$project$Analytics$decodeLinkData = A3(
	elm$json$Json$Decode$map2,
	author$project$Analytics$LinkData,
	A2(elm$json$Json$Decode$field, 'longUrl', elm$json$Json$Decode$string),
	A2(elm$json$Json$Decode$field, 'clicks', elm$json$Json$Decode$int));
var elm$core$Platform$Cmd$batch = _Platform_batch;
var elm$core$Platform$Cmd$none = elm$core$Platform$Cmd$batch(_List_Nil);
var elm$json$Json$Decode$decodeValue = _Json_run;
var author$project$Analytics$init = function (flags) {
	return _Utils_Tuple2(
		A2(elm$json$Json$Decode$decodeValue, author$project$Analytics$decodeLinkData, flags),
...
var mdgriffith$elm_ui$Internal$Style$classes = {bL: 'a', aB: 'atv', bN: 'ab', bO: 'cx', bP: 'cy', bQ: 'acb', bR: 'accx', bS: 'accy', bT: 'acr', aX: 'al', aY: 'ar', bU: 'at', aC: 'ah', aD: 'av', bW: 's', b_: 'bh', b$: 'b', b1: 'w7', b3: 'bd', b4: 'bdt', al: 'bn', b5: 'bs', am: 'cpe', ca: 'cp', cb: 'cpx', cc: 'cpy', A: 'c', ao: 'ctr', ap: 'cb', aq: 'ccx', B: 'ccy', ad: 'cl', ar: 'cr', ce: 'ct', cf: 'cptr', cg: 'ctxt', cn: 'fcs', co: 'fs', cp: 'g', aH: 'hbh', at: 'hc', aI: 'hf', a8: 'hfp', cr: 'hv', ct: 'ic', cv: 'fr', cx: 'iml', cy: 'it', cz: 'i', X: 'nb', bg: 'notxt', cE: 'ol', cG: 'or', O: 'oq', cK: 'oh', bk: 'pg', bl: 'p', cL: 'ppe', cO: 'ui', s: 'r', cQ: 'sb', cR: 'sbx', cS: 'sby', cT: 'sbt', cW: 'e', cX: 'cap', cY: 'sev', c3: 'sk', p: 't', c6: 'tc', c7: 'w8', c8: 'w2', c9: 'w9', da: 'tj', ay: 'tja', db: 'tl', dc: 'w3', dd: 'w5', de: 'w4', df: 'tr', dg: 'w6', dh: 'w1', di: 'tun', bE: 'ts', Q: 'clr', dn: 'u', aT: 'wc', bI: 'we', aU: 'wf', bJ: 'wfp', aV: 'wrp'};
var mdgriffith$elm_ui$Internal$Model$columnClass = mdgriffith$elm_ui$Internal$Style$classes.bW + (' ' + mdgriffith$elm_ui$Internal$Style$classes.A);
...
var mdgriffith$elm_ui$Internal$Model$rowClass = mdgriffith$elm_ui$Internal$Style$classes.bW + (' ' + mdgriffith$elm_ui$Internal$Style$classes.s);
var mdgriffith$elm_ui$Internal$Model$singleClass = mdgriffith$elm_ui$Internal$Style$classes.bW + (' ' + mdgriffith$elm_ui$Internal$Style$classes.cW);
	...
	switch (style.$) {
		...
		case 8:
			...
			return 'grid-rows-' + (A2(
				...
				elm$core$String$join,
				'-',
				A2(elm$core$List$map, mdgriffith$elm_ui$Internal$Model$lengthClassName, template.u)) + ('-space-x-' + (mdgriffith$elm_ui$Internal$Model$lengthClassName(template.cZ.a) + ('-space-y-' + mdgriffith$elm_ui$Internal$Model$lengthClassName(template.cZ.b)))))));
		case 9:
			var pos = style.a;
			return 'gp grid-pos-' + (elm$core$String$fromInt(pos.s) + ('-' + (elm$core$String$fromInt(pos.cd) + ('-' + (elm$core$String$fromInt(pos.ab) + ('-' + elm$core$String$fromInt(pos.W)))))));
		case 11:
...
var mdgriffith$elm_ui$Internal$Style$overrides = '@media screen and (-ms-high-contrast: active), (-ms-high-contrast: none) {' + (mdgriffith$elm_ui$Internal$Style$dot(mdgriffith$elm_ui$Internal$Style$classes.bW) + (mdgriffith$elm_ui$Internal$Style$dot(mdgriffith$elm_ui$Internal$Style$classes.s) + (' > ' + (mdgriffith$elm_ui$Internal$Style$dot(mdgriffith$elm_ui$Internal$Style$classes.bW) + (' { flex-basis: auto !important; } ' + (mdgriffith$elm_ui$Internal$Style$dot(mdgriffith$elm_ui$Internal$Style$classes.bW) + (mdgriffith$elm_ui$Internal$Style$dot(mdgriffith$elm_ui$Internal$Style$classes.s) + (' > ' + (mdgriffith$elm_ui$Internal$Style$dot(mdgriffith$elm_ui$Internal$Style$classes.bW) + (mdgriffith$elm_ui$Internal$Style$dot(mdgriffith$elm_ui$Internal$Style$classes.ao) + (' { flex-basis: auto !important; }}' + (mdgriffith$elm_ui$Internal$Style$sliderOverrides + mdgriffith$elm_ui$Internal$Style$explainer))))))))))));
...
var mdgriffith$elm_ui$Internal$Style$emptyIntermediate = F2(
	function (selector, closing) {
		return {an: closing, f: _List_Nil, F: _List_Nil, x: selector};
	});
					...
					case 2:
						...
						return _Utils_update(
							rendered,
							{
								f: A2(
									elm$core$List$cons,
									{an: '\n}', f: _List_Nil, F: props, x: '@supports (' + (prop + (':' + (value + (') {' + parent.x))))},
									rendered.f)
							});
					case 4:
						var selector = rule.a;
...
var mdgriffith$elm_ui$Internal$Model$adjust = F3(
	function (size, height, vertical) {
		return {W: height / size, aQ: size, bG: vertical};
	});
var mdgriffith$elm_ui$Internal$Model$convertAdjustment = function (adjustment) {
	var lines = _List_fromArray(
		[adjustment.b8, adjustment.bZ, adjustment.ch, adjustment.cB]);
	var lineHeight = 1.5;
				...
				switch (rule.$) {
					...
					case 9:
						...
						var modernPosition = A2(
							...
							_List_fromArray(
								[
									'grid-row: ' + (elm$core$String$fromInt(position.s) + (' / ' + (elm$core$String$fromInt(position.s + position.W) + ';'))),
									'grid-column: ' + (elm$core$String$fromInt(position.cd) + (' / ' + (elm$core$String$fromInt(position.cd + position.ab) + ';')))
								]));
						var _class = '.grid-pos-' + (elm$core$String$fromInt(position.s) + ('-' + (elm$core$String$fromInt(position.cd) + ('-' + (elm$core$String$fromInt(position.ab) + ('-' + elm$core$String$fromInt(position.W)))))));
					...
					return A3(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										elm$html$Html$Attributes$class(mdgriffith$elm_ui$Internal$Style$classes.bW + (' ' + mdgriffith$elm_ui$Internal$Style$classes.cW))
									]))
							]));
			}
		}();
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[mdgriffith$elm_ui$Internal$Style$classes.bW, mdgriffith$elm_ui$Internal$Style$classes.cW, mdgriffith$elm_ui$Internal$Style$classes.ao, mdgriffith$elm_ui$Internal$Style$classes.B, mdgriffith$elm_ui$Internal$Style$classes.bT])))
						]),
					_List_fromArray(
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[mdgriffith$elm_ui$Internal$Style$classes.bW, mdgriffith$elm_ui$Internal$Style$classes.cW, mdgriffith$elm_ui$Internal$Style$classes.ao, mdgriffith$elm_ui$Internal$Style$classes.B, mdgriffith$elm_ui$Internal$Style$classes.bR])))
						]),
					_List_fromArray(
						[html])) : html));
			case 1:
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[mdgriffith$elm_ui$Internal$Style$classes.bW, mdgriffith$elm_ui$Internal$Style$classes.cW, mdgriffith$elm_ui$Internal$Style$classes.ao, mdgriffith$elm_ui$Internal$Style$classes.bS])))
						]),
					_List_fromArray(
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[mdgriffith$elm_ui$Internal$Style$classes.bW, mdgriffith$elm_ui$Internal$Style$classes.cW, mdgriffith$elm_ui$Internal$Style$classes.ao, mdgriffith$elm_ui$Internal$Style$classes.bQ])))
						]),
					_List_fromArray(
						[html])) : html));
			default:
		...
		_List_fromArray(
			[
				...
				A2(
					...
					' ',
					_List_fromArray(
						[mdgriffith$elm_ui$Internal$Style$classes.bW, mdgriffith$elm_ui$Internal$Style$classes.p, mdgriffith$elm_ui$Internal$Style$classes.aT, mdgriffith$elm_ui$Internal$Style$classes.at])))
			]),
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				A2(
					...
					' ',
					_List_fromArray(
						[mdgriffith$elm_ui$Internal$Style$classes.bW, mdgriffith$elm_ui$Internal$Style$classes.p, mdgriffith$elm_ui$Internal$Style$classes.aU, mdgriffith$elm_ui$Internal$Style$classes.aI])))
			]),
		_List_fromArray(
			[
						...
						switch (location) {
							case 0:
								return A2(
									...
									' ',
									_List_fromArray(
										[mdgriffith$elm_ui$Internal$Style$classes.X, mdgriffith$elm_ui$Internal$Style$classes.cW, mdgriffith$elm_ui$Internal$Style$classes.bL]));
							case 1:
								return A2(
									elm$core$String$join,
									' ',
									_List_fromArray(
										[mdgriffith$elm_ui$Internal$Style$classes.X, mdgriffith$elm_ui$Internal$Style$classes.cW, mdgriffith$elm_ui$Internal$Style$classes.b$]));
							case 2:
								return A2(
									elm$core$String$join,
									' ',
									_List_fromArray(
										[mdgriffith$elm_ui$Internal$Style$classes.X, mdgriffith$elm_ui$Internal$Style$classes.cW, mdgriffith$elm_ui$Internal$Style$classes.cG]));
							case 3:
								return A2(
									elm$core$String$join,
									' ',
									_List_fromArray(
										[mdgriffith$elm_ui$Internal$Style$classes.X, mdgriffith$elm_ui$Internal$Style$classes.cW, mdgriffith$elm_ui$Internal$Style$classes.cE]));
							case 4:
								return A2(
									elm$core$String$join,
									' ',
									_List_fromArray(
										[mdgriffith$elm_ui$Internal$Style$classes.X, mdgriffith$elm_ui$Internal$Style$classes.cW, mdgriffith$elm_ui$Internal$Style$classes.cv]));
							default:
								return A2(
									elm$core$String$join,
									' ',
									_List_fromArray(
										[mdgriffith$elm_ui$Internal$Style$classes.X, mdgriffith$elm_ui$Internal$Style$classes.cW, mdgriffith$elm_ui$Internal$Style$classes.b_]));
						}
					}())
				]),
			_List_fromArray(
			...
			return (portion === 1) ? _Utils_Tuple3(
				...
				_List_fromArray(
					[
						...
						mdgriffith$elm_ui$Internal$Style$classes.bW + ('.' + (mdgriffith$elm_ui$Internal$Style$classes.s + (' > ' + mdgriffith$elm_ui$Internal$Style$dot(
								...
								case 2:
									...
									if (portion === 1) {
										...
										var $temp$classes = classes + (' ' + (mdgriffith$elm_ui$Internal$Style$classes.a8 + (' height-fill-' + elm$core$String$fromInt(portion)))),
											...
											A3(
												mdgriffith$elm_ui$Internal$Model$Single,
												mdgriffith$elm_ui$Internal$Style$classes.bW + ('.' + (mdgriffith$elm_ui$Internal$Style$classes.A + (' > ' + mdgriffith$elm_ui$Internal$Style$dot(
													'height-fill-' + elm$core$String$fromInt(portion))))),
												'flex-grow',
												elm$core$String$fromInt(portion * 100000)),
											styles),
...
var author$project$Analytics$view = function (model) {
	if (!model.$) {
		var linkData = model.a;
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							mdgriffith$elm_ui$Element$text('Original URL: '),
							A2(
							mdgriffith$elm_ui$Element$link,
							_List_Nil,
							{
								cA: mdgriffith$elm_ui$Element$text(linkData.aJ),
								dp: linkData.aJ
							})
						])),
					mdgriffith$elm_ui$Element$text(
					'Clicks: ' + elm$core$String$fromInt(linkData.a1))
				]));
	} else {
		var error = model.a;
		return A2(
...
var mdgriffith$elm_ui$Internal$Model$optionsToRecord = function (options) {
	...
	return andFinally(
		A3(
			elm$core$List$foldr,
			combine,
			{cn: elm$core$Maybe$Nothing, cr: elm$core$Maybe$Nothing, cC: elm$core$Maybe$Nothing},
			options));
};
			...
			A2(
				...
				mdgriffith$elm_ui$Internal$Model$htmlClass(
					A2(
						...
						' ',
						_List_fromArray(
							[mdgriffith$elm_ui$Internal$Style$classes.cO, mdgriffith$elm_ui$Internal$Style$classes.bW, mdgriffith$elm_ui$Internal$Style$classes.cW]))),
				_Utils_ap(mdgriffith$elm_ui$Internal$Model$rootStyle, attrs)),
			child);
	});
var mdgriffith$elm_ui$Element$layout = mdgriffith$elm_ui$Element$layoutWith(
	{bi: _List_Nil});
var author$project$Analytics$main = elm$browser$Browser$document(
	{
		cw: author$project$Analytics$init,
		c5: elm$core$Basics$always(elm$core$Platform$Sub$none),
		$7: F2(
			function (msg, model) {
			...
			return {
				b0: _List_fromArray(
					[
						...
						_List_Nil,
						author$project$Analytics$view(model))
					]),
				dk: 'Analytics | Link Shortener'
			};
		}
	});
_Platform_export({'Analytics':{'init':author$project$Analytics$main(elm$json$Json$Decode$value)(0)}});}(this));